...
using Pkg
Pkg.update()
Pkg.add(url="https://github.com/biaslab/ECC-MARX#main")
using MARX
using JLD2
end
...
# ╔═╡ 50f3f3b3-9e7b-4c12-8e24-3ecea705562e
md"### NOTE: The double mass-spring-damper system is a dynamical system with unknown state transition matrix A. Thus, we do not have access to some plots."
...
plot_param_M_timeseries(results["MARX-WI"].recs_train[hyperparams_run_WI.run,hyperparams_debug.T], indices=A_indices, f_name="figures/$(label_env)-coeffs-A-timeline-selection.png")
